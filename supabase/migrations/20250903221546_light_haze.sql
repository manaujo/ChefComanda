/*
  # Configuração Final dos Produtos Reais da Stripe

  1. Price IDs Reais Configurados
...
BEGIN
  ...
  RAISE NOTICE 'Webhook Secret configurado: whsec_yuJa1uPPPblLyaCVxg57px3wYGUZWrjQ';
