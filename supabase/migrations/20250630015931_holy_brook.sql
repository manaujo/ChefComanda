/*
  ...
  1. Changes
    - Drop existing employee_auth and employee_sessions tables if they exist
    - Recreate tables with proper structure
    - Add policies with proper checks to prevent duplicates
    - Add functions for authentication and session management
...
-- Policies for employee_sessions
...
-- Create trigger for employee auth changes
...
-- Create trigger for employee sessions
...
-- Create trigger for user status check
