/*
  ...
  1. Problem Fixed
    - Cannot change return type of existing function get_user_subscription_details
    - Need to DROP the function first before recreating with new signature

  2. Solution
    - Drop existing function with all possible signatures
    - Recreate with correct return type
    - Update all related functions with proper variable names
